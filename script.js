...
function clickButton(){
    ...
    if (document.getElementById("uname").value == "" || document.getElementById("startingbid").value == ""){
        ...
        for(var i = 0; i < reputation_counter.length; i++){
            if(reputation_counter[i] < 0 && reputation_counter > -100){
        ...
        document.getElementById("number").innerHTML = `Total price: ${t_res}$`;
    }
